...
namespace Business.Concrete
{
    public class BookManager : IBookService
    {
        ...
        public void Add(Book book, string dosyayolu)
        {
            ...
            var tamDosyaAdi = Path.Combine(dosyayolu, book.PictureFile.FileName);
            using (var dosyaAkisi = new FileStream(tamDosyaAdi, FileMode.Create))
            {
                book.PictureFile.CopyTo(dosyaAkisi);
            }

            book.Picture = book.PictureFile.FileName;
            //business code
            _bookDal.Add(book);
        }
