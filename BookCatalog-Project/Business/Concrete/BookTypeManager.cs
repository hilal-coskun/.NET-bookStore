...
namespace Business.Concrete
{
    public class BookTypeManager : IBookTypeService
    {
        ...
        {
            return _bookTypeDal.GetListWithBookCategories();
        }

        public List<BookType> SearchFilter(string Empsearch, string EmpsearchName)
        {
            return _bookTypeDal.SearchFilter(Empsearch, EmpsearchName);
        }

        public BookType GetByIdCategories(int bookcategoryId)
        {
            return _bookTypeDal.GetByIdWithBookCategories(bookcategoryId);
        }
    }
}
