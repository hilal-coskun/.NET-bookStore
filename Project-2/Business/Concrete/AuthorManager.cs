...
namespace Business.Concrete
{
    public class AuthorManager : IAuthorService
    {
        ...
        public void Add(Author author, string dosyayolu)
        {
            ...
            var tamDosyaAdi = Path.Combine(dosyayolu, author.LogoFile.FileName);
            using (var dosyaAkisi = new FileStream(tamDosyaAdi, FileMode.Create))
            {
                author.LogoFile.CopyTo(dosyaAkisi);
            }

            author.Logo = author.LogoFile.FileName;
            //business code
